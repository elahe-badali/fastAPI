...
MLFLOW_TRACKING_USERNAME = os.getenv("MLFLOW_TRACKING_USERNAME", "student_elaheh_badali") #
MLFLOW_TRACKING_PASSWORD = os.getenv("MLFLOW_TRACKING_PASSWORD", "AB9XBnbNX4VW6YSgRkY") #
...
MLFLOW_RUN_ID = os.getenv("MLFLOW_RUN_ID", "6850fbb8dc784ea0850400865ddae4a1").strip() #
